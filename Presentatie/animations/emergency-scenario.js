// emergency-scenario.js — Animation stub (Cyclus 2: replace with real implementation)
...
export function init(container, options = {}) {
  ...
  el.textContent = '🎬 emergency-scenario';
  container.appendChild(el);

  const stub = createStub('emergency-scenario');
  return {
    ...stub,
    destroy() {
      el.remove();
